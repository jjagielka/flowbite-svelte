...
## [1.0.0](https://github.com/jjagielka/flowbite-svelte/compare/v0.27.0...v1.0.0) (2022-09-24)
...
* add $$slots.arrowdown and arrowup for user icons ([3fa53de](https://github.com/jjagielka/flowbite-svelte/commit/3fa53de11239fe93e2ae9e28e5bdf3ee3ccc1f69))
* add active color to InteractiveTabs and InteractiveTabHead component ([7995e21](https://github.com/jjagielka/flowbite-svelte/commit/7995e210f98325350b055a43199fa4d7750ea225))
* add active to SidebarItem component and an example in the page ([af80c2b](https://github.com/jjagielka/flowbite-svelte/commit/af80c2b7c1d81e711bba0faca959e6501b31257c))
* add bgColor and bgOpacity to Drawer component ([8dc01fb](https://github.com/jjagielka/flowbite-svelte/commit/8dc01fb9ec82b14d5f893d1255b646630e205ce2))
* add bind:value to Iconinput ([87616e2](https://github.com/jjagielka/flowbite-svelte/commit/87616e2222611bfabd77c3f7699c5f716015e420))
* add Blockquote ([89cbfbd](https://github.com/jjagielka/flowbite-svelte/commit/89cbfbdf56e7beca90b00cf4c9c033789b2a2ba5))
* add ChevronUp to SidebarDropdownWrapper ([032d540](https://github.com/jjagielka/flowbite-svelte/commit/032d540b347ab30ddcdcddff8c0963290ce0c904))
* add custom color to Alert component and update props ([2e2a71b](https://github.com/jjagielka/flowbite-svelte/commit/2e2a71b4fb83bca28a1bf6b107f4163acbb6b011))
* add DescriptionList, List, Span components ([495b61e](https://github.com/jjagielka/flowbite-svelte/commit/495b61eb0d81eb9ae06a34fa981dd42a81983ea6))
* add disabled and classes to InteractiveTabHead component ([869fb1b](https://github.com/jjagielka/flowbite-svelte/commit/869fb1b34f5a0e5a254cdc09b25195bf621a25d6))
* add disabled to InteractiveTabs ([f5ca0fe](https://github.com/jjagielka/flowbite-svelte/commit/f5ca0fe858a50ef2c017ed6ec266c0012166b5f9))
* add export divClass to Toast for user custom CSS ([7625c01](https://github.com/jjagielka/flowbite-svelte/commit/7625c017af9a91920880b3d9c09d8f02924178e5))
* add H1, H2, A, P, Higlight components ([3f80473](https://github.com/jjagielka/flowbite-svelte/commit/3f804731e6a093c1e34f8b3be6289f930c372a96))
* add Heading and removed H1 and H2 ([b2be994](https://github.com/jjagielka/flowbite-svelte/commit/b2be9945c39bcbfe23a0df53348ce768c5958255))
* add highlight to Span component and update heading page ([d47121b](https://github.com/jjagielka/flowbite-svelte/commit/d47121ba47e6c6e3dfdd366128f51da77a966e0f))
* add Hr component and page ([f289c1e](https://github.com/jjagielka/flowbite-svelte/commit/f289c1ebd6cfcbcfde87b28ce3108abaf54248ca))
* add icon components rather than import a library ([9dffb40](https://github.com/jjagielka/flowbite-svelte/commit/9dffb400607d8bb4dd98e877e466956157016ff7))
* add Iconinput click handler example ([d815212](https://github.com/jjagielka/flowbite-svelte/commit/d8152126236e839d3d7bc6e035d0afa432d96856))
* add id to typograpy components ([64cbe1b](https://github.com/jjagielka/flowbite-svelte/commit/64cbe1b6f2cbe43fdf5cb71a0d82e3a5caad1586))
* add Img component, images, and page ([b2aec04](https://github.com/jjagielka/flowbite-svelte/commit/b2aec047694aab0bbcbc58d93af8c021e27d4f96))
* add Img page and examples ([ed3d83f](https://github.com/jjagielka/flowbite-svelte/commit/ed3d83f34e195d67e3c7a334d1226d0876441f47))
* add labelInsideClass to progressbar component ([fe20cd7](https://github.com/jjagielka/flowbite-svelte/commit/fe20cd7f693f21e052dc5adb3fd3eb4bcfa80b76))
* add Layout component ([2204586](https://github.com/jjagielka/flowbite-svelte/commit/22045861703bf3e46cc7900e15c4db64d5246c50))
* add link examples ([b129251](https://github.com/jjagielka/flowbite-svelte/commit/b12925106d6ffe482dfbde5623925f72abe8a577))
* add links page ([cdb2566](https://github.com/jjagielka/flowbite-svelte/commit/cdb2566640bc5153e4d310dc2306aaafe432f5de))
* add Mark and TextGradient ([343e719](https://github.com/jjagielka/flowbite-svelte/commit/343e719406bc146639882f97bbeafbc2de9514cb))
* add md files in components folder ([8d7e05a](https://github.com/jjagielka/flowbite-svelte/commit/8d7e05a0098437ac7ddd3f9122a2c23f481e54cd))
* add offset position props to Drawer and example in the drawer page ([680d358](https://github.com/jjagielka/flowbite-svelte/commit/680d358ef3d55df202ae2bcaf5deb9c3e6834c18))
* add PaperAirplane icon ([90d2543](https://github.com/jjagielka/flowbite-svelte/commit/90d25435eb9cc68b38febaba41b5782efb755981))
* add paragraphs page ([db973a3](https://github.com/jjagielka/flowbite-svelte/commit/db973a3929bfdc8c4dd48338cc114bdc2c808fb8))
* add placement to Drawer component ([1b91e52](https://github.com/jjagielka/flowbite-svelte/commit/1b91e52618da8935b326a69161d01f0cc7739158))
* add pointerEvent prop to Iconinput to show/hide cursor ([dffa324](https://github.com/jjagielka/flowbite-svelte/commit/dffa3247856c7245ecb8a67554ce77b797fe8627))
* add popover related files ([8b5050b](https://github.com/jjagielka/flowbite-svelte/commit/8b5050b0e9f6e45533b858c7aa392463cfb6cc91))
* add rating count and update app.css ([e5d642b](https://github.com/jjagielka/flowbite-svelte/commit/e5d642b4a246c1716db8461e6ecbc26a7abad9d0))
* add Review component ([67af517](https://github.com/jjagielka/flowbite-svelte/commit/67af517e32dfc19c6079e5d1925a234f0162cc34))
* add Review component ([d41b11d](https://github.com/jjagielka/flowbite-svelte/commit/d41b11d4ef00d1d6d0d824d4fcdc9c964a78a7d2))
* add Review component, page, and prop ([4446e1e](https://github.com/jjagielka/flowbite-svelte/commit/4446e1eba3706e291f0cb3812b4ffb61df48eb46))
* add server hooks to redirect component pages and add redirect.spec test ([9e2cb72](https://github.com/jjagielka/flowbite-svelte/commit/9e2cb72653cb2de16f77c30d73bd69a69bd73bd5))
* add size to Iconinput component ([f041953](https://github.com/jjagielka/flowbite-svelte/commit/f04195350a179d55a7315a127d5b116deaac1f41))
* add size to Rating component ([7c2784e](https://github.com/jjagielka/flowbite-svelte/commit/7c2784efff60877014c14a8acc7760f845671100))
* add sticky footer, add $$props.class to all skeleton components ([1fad8dc](https://github.com/jjagielka/flowbite-svelte/commit/1fad8dc9d8c0bc1428daeada82f44accc5f7e9a0))
* add sticky navbar ([4010ea8](https://github.com/jjagielka/flowbite-svelte/commit/4010ea85483cf0c5a26275fe710ed34e4142846e))
* add Tabs component for all tab ([758e2e7](https://github.com/jjagielka/flowbite-svelte/commit/758e2e743eb845c7190a7c6c2a9888c67c46db73))
* add Text decoration examples to text page ([fe074cd](https://github.com/jjagielka/flowbite-svelte/commit/fe074cd2a36d780333444f276de69edec51649d5))
* add Ul, Li, Span component ([86d8b66](https://github.com/jjagielka/flowbite-svelte/commit/86d8b661f2524f25162a99b6d3b8df761a85b01b))
* add underline and decoratio class to Span ([f3b11a9](https://github.com/jjagielka/flowbite-svelte/commit/f3b11a92b3782c27e09f25c894a81402661b73d3))
* add User review, User testimonial, Paragraph context, Blockquote icon to typography/blockquote page ([73143ba](https://github.com/jjagielka/flowbite-svelte/commit/73143bad816f6b3249fff3486d3b8569f45fde7f))
* button group ([bb95b98](https://github.com/jjagielka/flowbite-svelte/commit/bb95b98c0e4b70f3958c778ac2dc8367c67df8d7))
* change node version to 0.16.16 since new playwright and sveltekit require it, https://github.com/sveltejs/kit/issues/5842 ([6175c2c](https://github.com/jjagielka/flowbite-svelte/commit/6175c2cb54c60829eb329bce90772e59b888063f))
* combine Accordionflush and AccordionItem ([e53fa64](https://github.com/jjagielka/flowbite-svelte/commit/e53fa6421ca747ed46d6432b67715b3eedf4cbba))
* create utilities/closebutton, label, and toolbar ([3ad9775](https://github.com/jjagielka/flowbite-svelte/commit/3ad9775ffbed66908cbaa82845b86151e179d534))
* datepicker update. It needs rel=external for the link from sidebar menu and index page ([6fed169](https://github.com/jjagielka/flowbite-svelte/commit/6fed169402be79c0e0eba9a93766be5f0587ef41))
* dropdown as Popper + fixes ([67fdf78](https://github.com/jjagielka/flowbite-svelte/commit/67fdf7837f36d63b3683e0b6f6e78fbf91f6bf23))
* dropdown button ([f6347f2](https://github.com/jjagielka/flowbite-svelte/commit/f6347f280cbfc552d001aa22128026174b46a6f3))
* dropdown new version ([f17dbff](https://github.com/jjagielka/flowbite-svelte/commit/f17dbff9139a80d0629913315fd4e594e99c9f40))
* fixing standard-version ([cd316e4](https://github.com/jjagielka/flowbite-svelte/commit/cd316e412171689e04ec435dfc31abd89b7cbe1d))
* frame abstraction ([47e4126](https://github.com/jjagielka/flowbite-svelte/commit/47e4126fa02ff6b9c93d3ee7e17fee79195ac1d3))
* mdsvexamples ([fc542a0](https://github.com/jjagielka/flowbite-svelte/commit/fc542a0b6d09067fa62ae92ed44cb08408c19ad0))
* modal - crypto ([47cf678](https://github.com/jjagielka/flowbite-svelte/commit/47cf678ef2a7bf10c842e367a37e2aedebe7a8fc))
* modal - crypto + html ([26475ed](https://github.com/jjagielka/flowbite-svelte/commit/26475edd98a2c73fbe02580fefb4c8455e25f1bb))
* modal block background scroll ([f3eb627](https://github.com/jjagielka/flowbite-svelte/commit/f3eb62732dc899d6f1483d9f86a5c644c8d2edd2))
* modal internal scrolling ([7ca08ea](https://github.com/jjagielka/flowbite-svelte/commit/7ca08ea939e0116241c564738ec237bd501ca32c))
* more Frame inheritance ([bb72d69](https://github.com/jjagielka/flowbite-svelte/commit/bb72d6952386bd0f6dec4711795e3591a6837c02))
* new tab components and page ([7c53437](https://github.com/jjagielka/flowbite-svelte/commit/7c534377c31384b609774db19b0bace7fee3d5cb))
* popover ([c41ddc4](https://github.com/jjagielka/flowbite-svelte/commit/c41ddc408f3696e05ee66de4922b95ee5cee1a08))
* popover finalization ([c71481e](https://github.com/jjagielka/flowbite-svelte/commit/c71481ec18e2850488d86cfdb583587eae4a19b2))
* popper reloaded ([a4b851e](https://github.com/jjagielka/flowbite-svelte/commit/a4b851e2409356a90fd6aaae62db327b505bdcb2))
* popper reloaded part 2 ([2482870](https://github.com/jjagielka/flowbite-svelte/commit/2482870842386c8c1e5824869ce7822b8682e8a0))
* range - clean up ([79d35ca](https://github.com/jjagielka/flowbite-svelte/commit/79d35ca127094efb20e12ad3e14635cf607edddc))
* textarea ([47d51be](https://github.com/jjagielka/flowbite-svelte/commit/47d51be427b056793cf64e4089cf4a4a7ba310d7))
* textarea / fix ([93cdb01](https://github.com/jjagielka/flowbite-svelte/commit/93cdb019326ebcaddd3482c5e41c8a635461ac67))
* toolbar ([f02ff55](https://github.com/jjagielka/flowbite-svelte/commit/f02ff558fa938913c32117ff51b46bdd6088e38a))
* toolbar w/html ([93116c3](https://github.com/jjagielka/flowbite-svelte/commit/93116c34b4063eb9d166d85ef3dd7e20126fa29e))
* tooltips new API ([d9dacf9](https://github.com/jjagielka/flowbite-svelte/commit/d9dacf9f65e85be93a3458dd5359d614a0dd12a0))
* update noBorder and add example ([dffa324](https://github.com/jjagielka/flowbite-svelte/commit/dffa3247856c7245ecb8a67554ce77b797fe8627))
* video component and page ([27cd7df](https://github.com/jjagielka/flowbite-svelte/commit/27cd7df226dde37e8a598b6693ae8278671d5782))
* working on drawer ([07a8e02](https://github.com/jjagielka/flowbite-svelte/commit/07a8e02ceac450e7e7ceeb2ad9b98bfac7c7c1cf))
* working on Tabs ([201c124](https://github.com/jjagielka/flowbite-svelte/commit/201c124e33bed0d1b13cfe2e3f6ba5ea0bfc6c1c))
* wrapper added ([024b8e6](https://github.com/jjagielka/flowbite-svelte/commit/024b8e6a8db1e4961b1d26df67728cc0fb8b3025))


### Bug Fixes

* fix:  ([c613b17](https://github.com/jjagielka/flowbite-svelte/commit/c613b173480180fc5b2462f7547f2c747f6b0f86))
* fix:  ([70bab60](https://github.com/jjagielka/flowbite-svelte/commit/70bab603d3a2f143ae34447c828b174b59a3b5af))
* [#226](https://github.com/jjagielka/flowbite-svelte/issues/226) for double on:click in DropdownItem ([c125d2d](https://github.com/jjagielka/flowbite-svelte/commit/c125d2d02e3818cedb83994e930ca5cc7075571c))
* [#266](https://github.com/jjagielka/flowbite-svelte/issues/266) change {id} to  {...$$restProps} ([b02822f](https://github.com/jjagielka/flowbite-svelte/commit/b02822f273fe5b14613ec77e39285078a740cda0))
* [#273](https://github.com/jjagielka/flowbite-svelte/issues/273) remove number from select value type ([529510b](https://github.com/jjagielka/flowbite-svelte/commit/529510bc50e561b544175a350390d7f32291727c))
* [#274](https://github.com/jjagielka/flowbite-svelte/issues/274) change the links to singular for blocks components ([7378935](https://github.com/jjagielka/flowbite-svelte/commit/73789353f4d598722db88cecb595303e8d60ac31))
* [#281](https://github.com/jjagielka/flowbite-svelte/issues/281) ([5f79a5e](https://github.com/jjagielka/flowbite-svelte/commit/5f79a5e27e23f568ae8e82d3ee974eea93eaccab))
* 683restProps for toolbarbutton ([6ce830c](https://github.com/jjagielka/flowbite-svelte/commit/6ce830c2657c6727835ded2b01728c8830a1a7d2))
* add classOptions type to classes object ([2d7131b](https://github.com/jjagielka/flowbite-svelte/commit/2d7131b25a5f6766c2cadc2b2034cc3cf68b9528))
* add createprops, scripts gen:props and package ([0fa07af](https://github.com/jjagielka/flowbite-svelte/commit/0fa07af6a55819cf1d72d2f14ded5c400d7386db))
* add default style to TabHeadItem and TabHead and removed {tabStyle} from default example in tab page ([a9025c4](https://github.com/jjagielka/flowbite-svelte/commit/a9025c432d57fe6896ab20249d711ff7739c9f1c))
* add events to IconInput and on:input to Input components ([6668918](https://github.com/jjagielka/flowbite-svelte/commit/66689185cd6cdf94ab66e1ff05ba33fbcaf6be0f))
* add html block to text page ([37e910a](https://github.com/jjagielka/flowbite-svelte/commit/37e910ae269099865865580d419b8dd05dccb7a8))
* add icon page ([0f5c966](https://github.com/jjagielka/flowbite-svelte/commit/0f5c96626954d4174d10b99f2934365628f2ec08))
* add npm and node to packages.josn engines for vercel test ([52e61fa](https://github.com/jjagielka/flowbite-svelte/commit/52e61faf5152817af07adbf7a4947b90f61ef7fb))
* add other dir ([dc5e73f](https://github.com/jjagielka/flowbite-svelte/commit/dc5e73feaa44c3fc7f020967f2e342b08bafccdf))
* add redirect to all other directories ([6ca9ce0](https://github.com/jjagielka/flowbite-svelte/commit/6ca9ce0c38c2a417fc1bcd88520e609a0e1b2b0e))
* add rel=external and / to links to form page ([a237d18](https://github.com/jjagielka/flowbite-svelte/commit/a237d1811eb1d6d6f3af545f109c71b8cadbd014))
* add relative class to Hr component ([d8c6fbf](https://github.com/jjagielka/flowbite-svelte/commit/d8c6fbf367a43b7c13ea55a56ae9c9f0b94fa96e))
* add Table color hover and example ([b49c139](https://github.com/jjagielka/flowbite-svelte/commit/b49c139c6d09a4563d462b35a5c49da605006d79))
* add track to video component for A11y ([ef69a83](https://github.com/jjagielka/flowbite-svelte/commit/ef69a83325ab11e4d3548e5e28033ae9e02bfe40))
* alert more tweaks ([444b340](https://github.com/jjagielka/flowbite-svelte/commit/444b340f3a211f02572675b94624da4ae5d90c63))
* alert tweaks ([0c93b3c](https://github.com/jjagielka/flowbite-svelte/commit/0c93b3c27d8911cd4709f78c554f68e524cc06d4))
* avatar dot alignment ([2273c0c](https://github.com/jjagielka/flowbite-svelte/commit/2273c0ceb82cc634558e7e88aff295c722d73c9f))
* Avatar tooltip example ([ff7c1af](https://github.com/jjagielka/flowbite-svelte/commit/ff7c1af20306609f77831ff1d2632700a9f596da))
* blockquote page formating ([1641d45](https://github.com/jjagielka/flowbite-svelte/commit/1641d45bdc032c01cd201967bf362d9f8a19a422))
* breadcrumb and add rel=external to pages in the forms dir. ([509d72a](https://github.com/jjagielka/flowbite-svelte/commit/509d72ae703a0d844653da87aea9119a90cc1018))
* BREAKING CHANGE for timeline components ([8b30105](https://github.com/jjagielka/flowbite-svelte/commit/8b30105060d150d632ea6fbfac8e1f5639f82546))
* buttongroup divider ([f5bedaf](https://github.com/jjagielka/flowbite-svelte/commit/f5bedafa9a0b36f4a42a54e8c37593d7ee9d8916))
* buttons fine tuning ([353f631](https://github.com/jjagielka/flowbite-svelte/commit/353f6312557fbef802e4e0b61d3638ab4190d2e3))
* buttons fine tuning ([9f4c927](https://github.com/jjagielka/flowbite-svelte/commit/9f4c927fb8303e7e65163ecd6413cdb834d1a4f3))
* change BreadcrumbItem home for all pages ([f5f895f](https://github.com/jjagielka/flowbite-svelte/commit/f5f895f6157b03e435975c5735329f8dfc984485))
* change from import { CloseButton } from $lib to import CloseButton from "../utils/CloseButton.svelte" in lib dir ([4eb4346](https://github.com/jjagielka/flowbite-svelte/commit/4eb4346a2c4679d58c00309e0cb1a28304888a72))
* change from textColor to color in typography components ([e67224e](https://github.com/jjagielka/flowbite-svelte/commit/e67224e222d0d4f7cd44cabaf0c9c23d42e703f8))
* change function clickOutside to arrow function ([71e71e0](https://github.com/jjagielka/flowbite-svelte/commit/71e71e0e482ad9939f9d135b1608b5cc8d31d899))
* change href=# to href=/ in popover page ([f885a92](https://github.com/jjagielka/flowbite-svelte/commit/f885a924706e477349c975641fc6fba0b4df45e5))
* change ml-2 after get access to ml-1 ([b8ffc2c](https://github.com/jjagielka/flowbite-svelte/commit/b8ffc2ca5016737da2d40ed5b83d4ef5fdc07e08))
* change package.json>engines>node to 16.0.0 since Verce does not accept. But use local node v16.16.0 for playwright test ([08130e9](https://github.com/jjagielka/flowbite-svelte/commit/08130e988c1243b6a248737ed604223c694d5981))
* clean up import from utils for docs ([b50126d](https://github.com/jjagielka/flowbite-svelte/commit/b50126d2f78e7613e48008b46c0bd77cdc7471fa))
* clean up ref ([9e8427b](https://github.com/jjagielka/flowbite-svelte/commit/9e8427bdbe7ee397a8c5c123a75e48abca298781))
* commit after reset ([c3ee849](https://github.com/jjagielka/flowbite-svelte/commit/c3ee8494fffac749a1e32cbeba1cf722ba6cb578))
* copy from flowbite-svelte-new ([5a400fc](https://github.com/jjagielka/flowbite-svelte/commit/5a400fce508c53e57eec6f5e40ba5c468ef79481))
* create Coinbase, Fortmatic, Metamask, OperaWallet, and WalletConnect component ([f8eabc5](https://github.com/jjagielka/flowbite-svelte/commit/f8eabc5b23b8c0d9fab75deca393858952406660))
* create icon slot for Alert so that users can add svg or svelte component ([45244ec](https://github.com/jjagielka/flowbite-svelte/commit/45244ec05f99298d150751209980dce519873163))
* docs corrections ([f208323](https://github.com/jjagielka/flowbite-svelte/commit/f208323ac1457b88572aaae37531e6b3da1055de))
* docs corrections 2 ([5adb4d8](https://github.com/jjagielka/flowbite-svelte/commit/5adb4d816591d7bc9aff2e549fc364c80e650b4b))
* docs fixes due to dropdown api change ([869f8d7](https://github.com/jjagielka/flowbite-svelte/commit/869f8d7bdea3a7ba97702e31b52f0e33fce3c911))
* docs for radio ([add38b2](https://github.com/jjagielka/flowbite-svelte/commit/add38b26fd4669a591916b7fa42e107868cc90a1))
* done type check for all pages ([d91b018](https://github.com/jjagielka/flowbite-svelte/commit/d91b018c3a66a6ac4cef2317651e1821083ab033))
* Drawer placement right ([4fe9283](https://github.com/jjagielka/flowbite-svelte/commit/4fe928380f4bb95c59e311e7ccc3a8ae49fda89d))
* dropdown open/close api ([d2aa6f7](https://github.com/jjagielka/flowbite-svelte/commit/d2aa6f71e7e804d474eb46e58030097d9bd9962f))
* dropdown open/close api - docs ([f299c28](https://github.com/jjagielka/flowbite-svelte/commit/f299c284a4ef3c9539e17677b815f60dd8d1e6f2))
* DropdownItem as li only when childe of ul ([add2f16](https://github.com/jjagielka/flowbite-svelte/commit/add2f166883df2c237197f3327ad331dd0a1617d))
* **DropdownItem:** remove redundant part after else ([4182d5c](https://github.com/jjagielka/flowbite-svelte/commit/4182d5c970b3a683b47e228f4881585f4ca77d3b))
* dropdowns events docs ([a6d86b6](https://github.com/jjagielka/flowbite-svelte/commit/a6d86b671a5c481288a20c1fe68cfcfe0faea880))
* dropdowns tweaks ([ad797ca](https://github.com/jjagielka/flowbite-svelte/commit/ad797ca4a4a60abd7723b3b1415e70fb6e1328a6))
* fixing the tab page layout problem ([bc3b7bf](https://github.com/jjagielka/flowbite-svelte/commit/bc3b7bf32100abbbab3fede7fa6a912ff81d00f6))
* folder names without s and update tests ([4e9c9ce](https://github.com/jjagielka/flowbite-svelte/commit/4e9c9ce69e06b1a8e4394c3920c75606894c06d3))
* git reset --hard 344845b4 and update getting-started ([a941ed8](https://github.com/jjagielka/flowbite-svelte/commit/a941ed8169872a39bd37e809db718f09156fbbc2))
* github issue template ([b6b8fd4](https://github.com/jjagielka/flowbite-svelte/commit/b6b8fd46aa7491e29935fe62ca5dc617513ee5ee))
* github issue template 2 ([343c102](https://github.com/jjagielka/flowbite-svelte/commit/343c102ee1901c8d14fc75ab06a0fe28ac594a98))
* github issue template 3 ([e8c6a1b](https://github.com/jjagielka/flowbite-svelte/commit/e8c6a1b7d148d0137ca0e395bf5904e3a2ed408c))
* github issue template 4 ([5565625](https://github.com/jjagielka/flowbite-svelte/commit/5565625e343c197bd4d903878a2955eaae08b788))
* h3 change, modal page update ([945762f](https://github.com/jjagielka/flowbite-svelte/commit/945762f325736ac316a7d1cb68d546f0c8acd982))
* header blocking anchor links ([af6d2d6](https://github.com/jjagielka/flowbite-svelte/commit/af6d2d6eb9bb630e58e76fd214f8a14f0435dc2f))
* Heading and P update ([2313e3e](https://github.com/jjagielka/flowbite-svelte/commit/2313e3e5ecb38ee69839a26b12b7c41cc099f75e))
* Heading to the original code ([5604da5](https://github.com/jjagielka/flowbite-svelte/commit/5604da5f348420f8878e44d591e9a8704b23e4a0))
* homepage ([dedf355](https://github.com/jjagielka/flowbite-svelte/commit/dedf355835cf8b60aeb68a94b0e47a2034bea358))
* Htwo for typography pages ([0921539](https://github.com/jjagielka/flowbite-svelte/commit/0921539d06e54f89d9e9dd52c70cdbc81b62dd3e))
* Iconinput click handler example ([2f5afc7](https://github.com/jjagielka/flowbite-svelte/commit/2f5afc7554a7bb43d231cc39001ea31b9deafd1c))
* Iconinput has unused export property value when I install it ([b19afc9](https://github.com/jjagielka/flowbite-svelte/commit/b19afc9284aa2c92c5a15b89de9dc9111652f0f7))
* index blocks names, e.g. Tooltips to Tooltip ([5f902b2](https://github.com/jjagielka/flowbite-svelte/commit/5f902b22043838a3e3413679632c9516ea81b906))
* index page space ([6ab9a19](https://github.com/jjagielka/flowbite-svelte/commit/6ab9a19e004fc19ba3bd696acedbc5bbc0ced966))
* List in cards page to Listgroup ([b8e05f4](https://github.com/jjagielka/flowbite-svelte/commit/b8e05f4f97fbbb0236872b2b5f18f0928c34ad55))
* megamenu fullscreen position ([eaf0729](https://github.com/jjagielka/flowbite-svelte/commit/eaf07294a728b524f2873df26f8250d23682dd81))
* migrate to sveltekit 1.0.0 ([434ec99](https://github.com/jjagielka/flowbite-svelte/commit/434ec998e1f96ab5e35eda6c6c78f6db2279aa4e))
* missing 683restProps ([0d52fd1](https://github.com/jjagielka/flowbite-svelte/commit/0d52fd1b4168c8cc707c174dc2c18f532cf2e93c))
* missing Popper ([ff4b0e7](https://github.com/jjagielka/flowbite-svelte/commit/ff4b0e772e228f03c1024e222fcc91e63adc23ba))
* mousenter ([c3ee1cc](https://github.com/jjagielka/flowbite-svelte/commit/c3ee1cc24867be96860faa32e322b6fe7c41592a))
* move @floating-ui/dom from dependencies to devDependencies ([6668ec8](https://github.com/jjagielka/flowbite-svelte/commit/6668ec8ca1559366ad0cbc223c9c91e3337ceb22))
* move @floating-ui/dom, classnames, svelte-heros, @popperjs/core from devDpendencies to dependencies ([ee5d31a](https://github.com/jjagielka/flowbite-svelte/commit/ee5d31af1b23e00e565c2a60b354b85f2beb54d1))
* navbar in mobile view width ([7f283f3](https://github.com/jjagielka/flowbite-svelte/commit/7f283f363ff5fc70430db83bddde3af24e94aa9a))
* navbar updates ([468839b](https://github.com/jjagielka/flowbite-svelte/commit/468839bd2efee738787b428ef902cecee3f70e12))
* no dropdown docs ([4f92d9b](https://github.com/jjagielka/flowbite-svelte/commit/4f92d9b56a53677bed7264b6f044e64a10c42c7e))
* no href on <a> buttons ([ab13df8](https://github.com/jjagielka/flowbite-svelte/commit/ab13df85aeac5368383bb708c9cb3146e418066f))
* no triggers error ([83075e1](https://github.com/jjagielka/flowbite-svelte/commit/83075e1a969bdf93a520bd9e35b339e36bf4f325))
* placement and padding ([169c749](https://github.com/jjagielka/flowbite-svelte/commit/169c749004d16d9b7c1aef46448608beefd3caf7))
* popover html ([d49f808](https://github.com/jjagielka/flowbite-svelte/commit/d49f808b8a05bd735a9f90c661710dddfd163cad))
* programatic popper open merged ([86f9874](https://github.com/jjagielka/flowbite-svelte/commit/86f9874e1c2390e3571b6df96acfa61af23fd865))
* RatingComment component ([032aa24](https://github.com/jjagielka/flowbite-svelte/commit/032aa24925f082459992104d5040804e0d532153))
* rebase merge conflict Alert.svelte ([38df84a](https://github.com/jjagielka/flowbite-svelte/commit/38df84a21124d3d3c3c1d716ff21bd678b156b09))
* remove activeTabvalue from TabWrapper and let:tabId vrom tab page examples ([ee1b444](https://github.com/jjagielka/flowbite-svelte/commit/ee1b444cd552de4cd0c13e4356159ce44a864024))
* remove bind: from TabWrapper bind:activeTabValue ([0269b3a](https://github.com/jjagielka/flowbite-svelte/commit/0269b3ac4daf31cebec6f215983bfb4e99a118e3))
* remove custom from Button component ([6114f4c](https://github.com/jjagielka/flowbite-svelte/commit/6114f4c9f5d9ad0848d5e7c000db6c4c9661ad39))
* remove Datepicker from index ([f08230c](https://github.com/jjagielka/flowbite-svelte/commit/f08230c84d29f172f1a30a6194e2694eb65f3e3e))
* remove Figma from image page ([0276b51](https://github.com/jjagielka/flowbite-svelte/commit/0276b517fc828e77bfd383be122b514bb0793da0))
* remove flowbite-svelte-blocks page, add a link ([2b9e3d3](https://github.com/jjagielka/flowbite-svelte/commit/2b9e3d3f72731ace8abb563e28e98309dbc58b3b))
* remove h-4 w-4 from Iconinput example in the input-field page ([4d5f396](https://github.com/jjagielka/flowbite-svelte/commit/4d5f396ea80389b88ec6a8437228d5dbadd46877))
* remove heros from cards page ([c46f0b3](https://github.com/jjagielka/flowbite-svelte/commit/c46f0b3f9a16793f12d68fd3d1b9e973dd1f7b4a))
* remove heros from megamenu and list-group page ([9980b7d](https://github.com/jjagielka/flowbite-svelte/commit/9980b7d98668c0356217dd3aac810c52cd5e0e51))
* remove heros from popover page ([eeff79f](https://github.com/jjagielka/flowbite-svelte/commit/eeff79f53733a8f5cbb480eead692f111f96b07c))
* remove heros from sidebars page ([a3981a0](https://github.com/jjagielka/flowbite-svelte/commit/a3981a09b6b36dcbcb90cfad789bee6a10dae9a1))
* remove heros from: ([57f6928](https://github.com/jjagielka/flowbite-svelte/commit/57f69282190f5d33d7ac17c6adeab36b89184f47))
* remove heros from: ([7055f4c](https://github.com/jjagielka/flowbite-svelte/commit/7055f4c5ddaa91e15cabaf7d1112a149cf81374d))
* remove heros icon from Carousel ([2c7d4c9](https://github.com/jjagielka/flowbite-svelte/commit/2c7d4c9a6edc1a4dd4005e5dcf46fec8b5dc0a52))
* remove heros icons from ([203f14c](https://github.com/jjagielka/flowbite-svelte/commit/203f14c578e57429892e0df41452abbdef1b3a4e))
* remove heros icons from buttons page ([ec81a39](https://github.com/jjagielka/flowbite-svelte/commit/ec81a393f438e2285d36ed7fea787af956c6f128))
* remove heros icons from checkbox page ([1ed983c](https://github.com/jjagielka/flowbite-svelte/commit/1ed983c2b230e6309ae6882972176480f8060487))
* remove heros icons from select and toggle pages ([fba7660](https://github.com/jjagielka/flowbite-svelte/commit/fba7660c1bf08c47a9d0200db545f0b1fce457a9))
* remove Home icons from all pages ([7ac0e7a](https://github.com/jjagielka/flowbite-svelte/commit/7ac0e7aa3edc5486d597a61775a5694c76b4bb35))
* remove layout and page content ([92609e5](https://github.com/jjagielka/flowbite-svelte/commit/92609e5a8dd85b22daaf12dda526331184bb4e74))
* remove old tab components ([a61dd72](https://github.com/jjagielka/flowbite-svelte/commit/a61dd728d1eb01bdbfeb61ff3adf8f96d7a1fbde))
* remove svelte-flag-icons from devDependencies ([8f48867](https://github.com/jjagielka/flowbite-svelte/commit/8f488677958313a2debaa3f953314d6452a63013))
* remove svelte:component from FooterIcon ([0406128](https://github.com/jjagielka/flowbite-svelte/commit/04061286046845c7f5c34f56ef89013d4a610aee))
* remove tabId from TabHead component ([2d7131b](https://github.com/jjagielka/flowbite-svelte/commit/2d7131b25a5f6766c2cadc2b2034cc3cf68b9528))
* remove tabId from TabWrapper component ([5f46d23](https://github.com/jjagielka/flowbite-svelte/commit/5f46d238ff1c81c1c66c1542565aa589f97cf530))
* remove TextGradient and Underline ([cb7b2d7](https://github.com/jjagielka/flowbite-svelte/commit/cb7b2d753f110cad4677f990d60a11154e38ac93))
* remove Toc from layout since it needs to be updated ([2ea41a0](https://github.com/jjagielka/flowbite-svelte/commit/2ea41a0c82bb8a7f583a001c1c5f598ac5855102))
* remove unused icon prop ([10e8c81](https://github.com/jjagielka/flowbite-svelte/commit/10e8c81dae9e0470ef875fc95dd7d89decdae732))
* remove unused imports ([acb58b9](https://github.com/jjagielka/flowbite-svelte/commit/acb58b9144948feeb3c1c14b41a71d2122187340))
* remove utils/OptsButton ([04ebd83](https://github.com/jjagielka/flowbite-svelte/commit/04ebd83aae8a3f3efabac8f3f144b65fabb04da1))
* removed drawer component and page from the main ([5cf77f0](https://github.com/jjagielka/flowbite-svelte/commit/5cf77f008aff26e64bd210a3bdf60e5f25aebc89))
* removed Home icon from BreadcrumbItem ([66f00dd](https://github.com/jjagielka/flowbite-svelte/commit/66f00dd9e024d97c2b9766e30b03b775f227c672))
* removed Ol component ([569f2e3](https://github.com/jjagielka/flowbite-svelte/commit/569f2e3a51a59abba641c669949b4b5372c56a01))
* rename List to Listgroup and ListItem to ListgroupItem ([1b70110](https://github.com/jjagielka/flowbite-svelte/commit/1b7011062a729452604b3a0dd1ed54f28ab49132))
* Review component and review in the ratings page ([afe6972](https://github.com/jjagielka/flowbite-svelte/commit/afe69726d08a3cad7de7f29db131909816bc9c3e))
* sidebar activeUrl example ([4387644](https://github.com/jjagielka/flowbite-svelte/commit/43876441726e70eb582c20778a6231ed03f963d7))
* spacing ([6f6e99c](https://github.com/jjagielka/flowbite-svelte/commit/6f6e99cec7209a70f9e09b362714f37525c45a53))
* tab page timeline ([ab598a5](https://github.com/jjagielka/flowbite-svelte/commit/ab598a59a3d373f14740a42bbaec3cb276eed34b))
* textarea docs ([133b933](https://github.com/jjagielka/flowbite-svelte/commit/133b9334841ac13d82c3a86bc24b3375de0972ff))
* toast transitions ([6659682](https://github.com/jjagielka/flowbite-svelte/commit/6659682250ab9d2337f06c2b424431366cf9ced0))
* toc issues ([13a459e](https://github.com/jjagielka/flowbite-svelte/commit/13a459ec6cc3c8768698c5525012f2b53ae94b5c))
* Toggle props and typo update ([9a40224](https://github.com/jjagielka/flowbite-svelte/commit/9a40224fc26bfefd9d28ec5d364bf4d7430da6f0))
* tooltips/popovers ([d18721c](https://github.com/jjagielka/flowbite-svelte/commit/d18721cc4229f5eb1f4dccbbd34dda65f6a07aac))
* type and layout footer padding fix ([999d291](https://github.com/jjagielka/flowbite-svelte/commit/999d29158fde736dbf4e19c9545fff6ba41dc7e7))
* typo ([ec6f019](https://github.com/jjagielka/flowbite-svelte/commit/ec6f019501acf4ba2fb105b8cc04a6d347d0dcf1))
* typo form and from ([f17012d](https://github.com/jjagielka/flowbite-svelte/commit/f17012db645030cf15ee62c28076f136ff28bed0))
* update Alert color type ([fd819fb](https://github.com/jjagielka/flowbite-svelte/commit/fd819fb59d2d01f900ad76449afabfa22de6d5b1))
* update bug_report.yml ([221f224](https://github.com/jjagielka/flowbite-svelte/commit/221f224920c69fb281c8b4fd2844a22fbe657c72))
* update bug_report.yml ([c527971](https://github.com/jjagielka/flowbite-svelte/commit/c52797111863fd3e52e7c3dae9473e22cd84923a))
* update bug_report.yml by adding REPL template link ([3c8140d](https://github.com/jjagielka/flowbite-svelte/commit/3c8140dffdedb3a41ee0ea9b546da92866fceefb))
* update Button color types ([974df12](https://github.com/jjagielka/flowbite-svelte/commit/974df12eaf2d796676700df09f2ee83d24ffc328))
* update Button component ([330aae9](https://github.com/jjagielka/flowbite-svelte/commit/330aae91c6c1b19cbbd1f35177f5e4bac9de3904))
* update createprops and update props ([0739b92](https://github.com/jjagielka/flowbite-svelte/commit/0739b9296caddcba85f849b222e6548a961dbd34))
* update Htwo using scroll-mt-20 ([2006490](https://github.com/jjagielka/flowbite-svelte/commit/200649069a05c6df4ed0e269d3479526092afe01))
* update icon class in TabHeadItem for Tabs with icons ([e94b344](https://github.com/jjagielka/flowbite-svelte/commit/e94b3449826e84146b877e00e458885e08606ec5))
* update Iconinput ([2b4a7b5](https://github.com/jjagielka/flowbite-svelte/commit/2b4a7b55f7db35f3e5b0cc042aa27a84ff741194))
* update pnpm-lock ([4926a47](https://github.com/jjagielka/flowbite-svelte/commit/4926a47bd529601b1a0709533fee2b5291e59eb8))
* update prop names for Alert ([3775700](https://github.com/jjagielka/flowbite-svelte/commit/377570061f48de43af44c5f87f46b049f4d87341))
* update rating page for AdvancedRating ([f1dc978](https://github.com/jjagielka/flowbite-svelte/commit/f1dc978b5775e0089cc6c8aa1fac1c5ed8b97dca))
* update svelte-sidebar-menu version ([1106d16](https://github.com/jjagielka/flowbite-svelte/commit/1106d161d06244d5db61641babc7691d28388fbd))
* update Timeline components ([4b47d6b](https://github.com/jjagielka/flowbite-svelte/commit/4b47d6b5d09abad3b2d8fc29c2b38287726c44d7))
* update tsconfig.json ([ff4b3da](https://github.com/jjagielka/flowbite-svelte/commit/ff4b3dacb420558c0beb627a75d9668e8fad88f9))
* use relative paths instead of $lib alias inside of lib ([96e9d6b](https://github.com/jjagielka/flowbite-svelte/commit/96e9d6bacb81761a26b0e43215c53ae24deffc73))
* video component and page ([cc8dcb5](https://github.com/jjagielka/flowbite-svelte/commit/cc8dcb54843ecff1f9aacc82d9139aedf7d6e0c1))
* window is undefined ([b752882](https://github.com/jjagielka/flowbite-svelte/commit/b752882ad0f0f6a7c196223649463903453f48d6))
* window is undefined/2 ([4c0ca77](https://github.com/jjagielka/flowbite-svelte/commit/4c0ca77eddfae2a04d10bc1ea3dc53671864b181))
